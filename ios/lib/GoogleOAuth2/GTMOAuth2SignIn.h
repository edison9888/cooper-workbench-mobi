...
@interface GTMOAuth2SignIn : NSObject {
 @private
  ...
  BOOL shouldFetchGoogleUserProfile_;
    BOOL shouldFetchGoogleUserTasks_;
    BOOL shouldFetchGoogleUserCalendar_;
...
@property (nonatomic, assign) BOOL shouldFetchGoogleUserTasks;
@property (nonatomic, assign) BOOL shouldFetchGoogleUserCalendar;
