...
-(void)setText:(NSString *)text
{
    ...
    CGSize size = [self.text sizeWithFont:self.font constrainedToSize:CGSizeMake([Tools screenMaxWidth], MAX_SIZE_HEIGHT) lineBreakMode:UILineBreakModeWordWrap];
